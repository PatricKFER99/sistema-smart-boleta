# 💎 Sistema de Gestión de Boletas - Minera DCV

![Estado del Proyecto](https://img.shields.io/badge/Estado-Completado-success?style=for-the-badge)
![Tecnologías](https://img.shields.io/badge/Stack-HTML_|_JS_|_Supabase-blue?style=for-the-badge)
![Despliegue](https://img.shields.io/badge/Deploy-Netlify-00C7B7?style=for-the-badge)

> **Plataforma web integral para la automatización, carga masiva y distribución segura de boletas de pago en el sector minero.**
...
* **📱 Diseño Responsivo:** Interfaz moderna y adaptable a cualquier dispositivo (Móvil/Desktop).

---

## 🛠️ Stack Tecnológico
Este proyecto implementa prácticas modernas de desarrollo y despliegue:

| Categoría | Tecnologías |
|-----------|-------------|
| **Frontend** | HTML5, CSS3 (Variables & Grid), JavaScript (ES6+) |
| **Backend (BaaS)** | Supabase (PostgreSQL, Auth, Storage) |
| **DevOps** | Git, GitHub, Netlify (CI/CD Automatizado) |
| **Librerías** | SweetAlert2 (Alertas modales) |
...
---
© 2025 Gachos- Minera DCV Project